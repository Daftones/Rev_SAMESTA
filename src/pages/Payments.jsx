...
import { Container, Card, Badge, Button, Row, Col, Alert, Spinner, OverlayTrigger, Tooltip } from 'react-bootstrap'
...
function Payments() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const uid = parsed?.id || parsed?.user_id || parsed?.email || ''
  ...
  const paymentsView = useMemo(() => payments, [payments])
